...
var cw = 320;
var ch = 240;
var g_speed1 = 60, g_speed2 = 60;//no  zero !!!
var fps = 1000/g_speed1;//1e3 / 30;
var hasSlow = false;
var canvas, context, levelCount, imageSprite, timeout;
var strings = {
	witr: "猜猜金币在哪儿？<br>（请选择）",
	fail: ["您猜错了，你已经扣了10000游币了", "您猜错了，你已经扣了10000游币了", "您猜错了，你已经扣了10000游币了"],
	ok: ["恭喜，已奖励2W积分","恭喜,已奖励2W积分","恭喜,已奖励2W积分"]
};
var init = function() {
	...
	var O = function(e) {
		...
		setTimeout(function() {
			...
			if (e == l) {
				...
				o.innerHTML = strings.ok[t-1];
				var datas = "ok";
				k();
			} else {
				o.innerHTML = strings.fail[livesCount];
				var datas = "fail";
			}
