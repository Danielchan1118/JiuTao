;(function($) {
    ...
    function showPublicBox(obj, options) {
        ...
        $(publicBoxId).css({"top":ofs.top+"px", "left":ofs.left+"px", "width":opts.width,"height":opts.height+"px"}).fadeIn(180);
    ...
    function pointMsg(obj, options) {
        ...
        opts.content = '<div id="typeface" style="color:'+opts.color+'"><br/>'+opts.msg+'</div>',
    ...
    function regPublicBoxCss() {
        var string = publicBoxId+' {'
                +'position: absolute; font-size:40px; font-family:"Microsoft Yahei",Arial,Helvetica,sans-serif,"宋体"; color:#F5F5F5;'
                +'width: 150px; padding: 200px 5px 5px; text-align: center; line-height: 60px;'
                +'border:0px; display:none;z-index: 20; background-color: #080808;'
                ...
                +publicBoxId+' .input_btn{ cursor: pointer; padding: 1px 6px; color: #333; line-height: 50px; float: none; margin: 55px 10px 10px 10px; width: 100px; height: 50px; font-size: 20px; font-weight: bold;}';
