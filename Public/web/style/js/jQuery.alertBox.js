;(function($) {
    ...
    function pointMsg(obj, options) {
        ...
        opts.content = '<div style="color:'+opts.color+'"><br/>'+opts.msg+'</div>',
    ...
    function regPublicBoxCss() {
        var string = publicBoxId+' {'
                +'position: absolute; font-size:18px; font-family:"Microsoft Yahei",Arial,Helvetica,sans-serif,"宋体"; color:#F5F5F5;'
                ...
                +publicBoxId+' .input_btn{ cursor: pointer; padding: 1px 6px; color: #333; line-height: 50px; float: none; margin: 15px 10px 10px 10px; width: 100px; height: 50px; font-size: 20px; font-weight: bold;}';
