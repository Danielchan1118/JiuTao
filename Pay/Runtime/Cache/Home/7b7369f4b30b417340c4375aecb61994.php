	...
	<div class="container">
		<div class="main center">
			...
			<ul id="middle_nav" class="clearfix">
				<li class="on"><a href="/UserCenter">个人资料</a></li>
			...
			<div id="my_info">
				...
				<div id="base_info">
					...
					<ul class="infos" style="display:none;">
						<li>用户名</li>
						<li class="right_info">
							<span id="nickname_span"><?php echo ($info["uid"]); ?></span>
							<input type="text" value="<?php echo ($info["uid"]); ?>" id="nickname">
							<!--等级图标-->
						</li> 
					</ul>
					<ul class="infos">
						<li>手机</li>
						<li class="right_info">
							<span id="phone_span"><?php echo ($info["mobiephone"]); ?></span>
							<input type="text" value="<?php echo ($info["mobiephone"]); ?>" id="phone">
						</li>
					</ul>
					<ul class="infos">
						<li>QQ</li>
						<li class="right_info">
							<span id="qq_span"><?php echo ($info["qq"]); ?></span>
							<input type="text" value="<?php echo ($info["qq"]); ?>" id="qq">
						</li>
					</ul>
				</div>
			</div>
