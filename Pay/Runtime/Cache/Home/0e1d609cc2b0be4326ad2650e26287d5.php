	...
	<div class="container">
		<div class="main center">
			...
			<ul id="middle_nav" class="clearfix">
				...
				<li><a href="/UserCenter/goods">我发布的商品</a></li>
				<li><a href="/UserCenter/collect">我的收藏</a></li>
				<li class="on"><a href="/UserCenter/message">消息中心</a></li>
			</ul>

			<div id="my_messages">
				<h1>
					<?php if(($all) == "1"): ?>全部消息列表
					<a href="/UserCenter/message?all=0">
						<span class="enshrine_it">未读消息</span>
					</a>
					<?php else: ?>
					未读消息列表
					<a href="/UserCenter/message?all=1">
						<span class="enshrine_it">全部消息</span>
					</a><?php endif; ?>
				</h1>
				<?php if(($letList["alread"]) != ""): if(is_array($letList["alread"])): $i = 0; $__LIST__ = $letList["alread"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="each_msg " >
					<div class="ensh_tips cmd_yours">
						<p><?php echo ($vo["from_user_nickname"]); ?> 评论了您的商品</p>
						<p><?php echo ($vo["content"]); ?></p>
						<div class="which_pro">
							<span> 商品<a href="javascript:void(0);" onclick="">“<?php echo ($vo["title"]); ?>”</a></span>
						</div>
					</div>
					<img class="msg_ph" src="<?php echo ($vo["from_user_head_img_url"]); ?>" alt="头像">
					<div class="msg_border"></div>
				</div><?php endforeach; endif; else: echo "" ;endif; endif; ?>
				<?php if(($letList["noread"]) != ""): if(is_array($letList["noread"])): $i = 0; $__LIST__ = $letList["noread"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="each_msg unread" >
					<div class="ensh_tips cmd_yours">
						<p><?php echo ($vo["from_user_nickname"]); ?> 评论了您的商品</p>
						<p><?php echo ($vo["content"]); ?></p>
						<div class="which_pro">
