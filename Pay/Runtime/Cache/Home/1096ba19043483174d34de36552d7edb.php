...
<html>
	<head>
		...
		<link rel="stylesheet" href="/Public/Home/style/css/sear.css?v=201412231400">
...
<body >
	...
	<div class="container">
		<div class="main center">
			<img class="search-icon-main" src="/Public/Home/style/image/search-icon-big.png" alt="<?php echo ($word); ?>">
			<div class="category-name"><?php echo ($word); ?></div>
			<hr size="1" color="#ffbb45">
			<div class="rank-by clearfix cur1" data-cur="1">
				<div class="wave ease2"></div>
			</div>
			<ul class="goods-list">
				<?php if(is_array($arrPayList)): $i = 0; $__LIST__ = $arrPayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clearfix">
						<a href="<?php echo U('Home/Goods/goodsDetail?id='.$vo['id']);?>" class="photo-wr" title="<?php echo ($vo["title"]); ?>" target="_blank">
							<img src="<?php echo ($www); echo ($vo["image_url"]); ?>" alt="<?php echo ($vo["title"]); ?>">
						</a>
						<div class="goods-info-wr">
							<div class="goods-title">
								<a href="<?php echo U('Home/Goods/goodsDetail?id='.$vo['id']);?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a>
							</div>
							<div class="goods-desc"><?php echo ($vo["content"]); ?></div>
							<div class="poster"><span><?php echo ((isset($vo["nickname"]) && ($vo["nickname"] !== ""))?($vo["nickname"]):"小淘"); ?></span></div>
							<div class="place"><span><?php echo ((isset($vo["location"]) && ($vo["location"] !== ""))?($vo["location"]):"火星"); ?></span></div>
							<?php if(($vo["biddata"]) != ""): ?><div class="price"><span><?php echo ($vo["biddata"]["current_price"]); ?></span></div>
							<?php else: ?>
								<div class="price"><span><?php echo ($vo["real_price"]); ?></span></div><?php endif; ?>					
						</div>
					</li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<div class="pages">
