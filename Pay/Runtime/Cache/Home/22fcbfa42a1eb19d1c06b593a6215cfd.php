	...
	<div class="container">
		<div class="main center">
			<div class="label-wr center clearfix">
				<div id="nav-labels">
					<a id="commend" class="labels cur" href="<?php echo U('/Index/index');?>">最新发布</a> 
					<a id="new_pro" class="labels " href="<?php echo U('/Index/nearList');?>">附近</a>
				</div>
			</div>
			<div class="item-list">
				...
				<?php if(is_array($arrPayList)): $i = 0; $__LIST__ = $arrPayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="item">
						...
						<div class="info">
							...
							<div class="department">
								...
								<span href="/" style="background-color: #ffbb45;color: #FFFFFF;padding: 3px 8px;border-radius: 15px;font-size: 13px;float: right;">
									<?php if(($vo["pay_type"]) == "1"): ?>想卖<?php endif; if(($vo["pay_type"]) == "2"): ?>交换<?php endif; if(($vo["pay_type"]) == "3"): ?>免费赠送<?php endif; if(($vo["pay_type"]) == "4"): ?>竞拍<?php endif; ?>
								</span>
							</div>
							<div class="school"><span><?php echo ((isset($vo["location"]) && ($vo["location"] !== ""))?($vo["location"]):"火星"); ?></span></div>
							<?php if($vo['period_status'] ==1): ?><div  style="position: absolute;top: 195px;margin-left: 27px;"><img src="/Public/Home/style/image/overdue.png"/></div><?php endif; ?>
						</div>
					</li>&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
					<!--循环end-->
					<li class="item fixed"></li>
					<li class="item fixed"></li>
					<li class="item fixed"></li></ul>
			</div>
			<div class="pages">
				<?php echo ($page); ?>
			</div>
