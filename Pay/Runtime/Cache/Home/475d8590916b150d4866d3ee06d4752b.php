	...
	<div class="container">
		<div class="main center">
			...
			<ul id="middle_nav" class="clearfix">
				...
				<li class="on"><a href="/UserCenter/collect">我的收藏</a></li>
				<li><a href="/UserCenter/message">消息中心</a></li>
			</ul>

			<div id="my_enshrine">

				<?php if(is_array($info["data"])): $i = 0; $__LIST__ = $info["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="enshr_each" id="goods<?php echo ($vo["id"]); ?>">
					<div class="enshr_info">
						<h2><a href="<?php echo U('Home/Goods/goodsDetail?id='.$vo['id']);?>"><?php echo ($vo["title"]); ?></a></h2>
						<p><?php echo ($vo["content"]); ?></p>
						<div class="enshr_state"> 
							<span class="enshrine_it" onclick="cancel_favorites(<?php echo ($vo["id"]); ?>);">取消收藏</span>
							<span class="onsaling"><?php echo ($vo["typeStr"]); ?></span>
						</div>
					</div>
